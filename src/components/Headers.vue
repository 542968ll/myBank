<template>
  ...
  <div v-if="myBG" class="w-[100%] h-[88px] bg-[#cf0000] flex justify-between items-center text-[#fff]">
    <div class="flex ml-[15px]">
      <img src="@/assets/img/xiancai.jpg" alt="" class="w-[45px] h-[45px] mr-[15px] rounded-[50%]">
